...
class Player:
    ...
    def shoot(self):
        self.weapon.add_bullet([self.angle, self.static_position[0]+32, self.static_position[1]+32])

    def draw(self):
        self.static_position = (self.position[0] - self.tiles().get_rect().width/2, self.position[1] - self.tiles().get_rect().height/2)
